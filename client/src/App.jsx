          ...
          {stage === 6 && (
            <motion.div
              ...
              <div className="text-center">
                <button
                  onClick={goBack}
                  className="flex flex-col items-center mx-auto -mt-8 mb-6 text-white/50 hover:text-white/90 transition-colors group">
                  <svg
                  ...
                  <span className="text-xs tracking-widest uppercase font-figtree">
                    Go back and edit
                  </span>
                </button>
                <img
