...
const Stage0 = ({ onComplete }) => {
  ...
  return (
    ...
    >
      <h1 className="text-5xl font-bold mb-3 font-serif tracking-tight text-white">
        RabbitHole
      </h1>
      <p className="text-white/60 text-[10px] uppercase tracking-[0.3em] mb-12 font-medium">
